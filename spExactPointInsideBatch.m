...
% Nonfinite XY has no finite-triangle hit. Keep +/-Inf and NaN Z in the
% scalar strict cutoff expression, which also supports legacy open fixtures.
finiteRows=find(all(isfinite(points(:,1:2)),2));
